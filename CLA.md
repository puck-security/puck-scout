# Puck Security Contributor License Agreement

Thank you for your interest in contributing to Puck.  Before we can accept
your code, you (or your employer) need to sign this Contributor License
Agreement (CLA).  The CLA gives Puck Security, Inc. the rights it needs to
distribute and sublicense your contribution as part of the project — while
...
There are two versions below.  Sign whichever applies:

- **[Individual CLA](#individual-contributor-license-agreement)** — if you
  are contributing as an individual, on your own time, with no employer
  claim to your work.
- **[Corporate CLA](#corporate-contributor-license-agreement)** — if you
  are contributing as part of your employment, or your employer has any
  rights in the work you contribute.  A signatory authorised to bind the
  company must sign this.

When you open your first pull request, the [CLA Assistant](https://github.com/contributor-assistant/github-action)
bot will comment with a link to sign.  Signing is a one-line comment on
the PR; the bot records signatures in
[`signatures/version1/cla.json`](signatures/version1/cla.json) in this
repository.
...
and future Contributions submitted to Puck Security, Inc. (the "Project").
...
authorised by the copyright owner that is making this Agreement with Puck
Security, Inc.  For legal entities, the entity making a Contribution and all
...
of the products owned or managed by the Project (the "Work").  For the
purposes of this definition, "submitted" means any form of electronic,
verbal, or written communication sent to the Project or its representatives,
including but not limited to communication on electronic mailing lists,
source code control systems, and issue tracking systems that are managed by,
or on behalf of, the Project for the purpose of discussing and improving
...
Puck Security, Inc. and to recipients of software distributed by the Project
...
Contributions from any person or entity, Puck Security, Inc. (the "Project")
must have a Contributor License Agreement (CLA) on file that has been signed
by each Contributor, indicating agreement to the license terms below.  This
...
Contributions to the Project, to authorise Contributions submitted by its
designated employees to the Project, and to grant copyright and patent
licenses thereto.
...
**"Contribution"** has the same meaning as in the Individual CLA above.
...
You represent further that each employee of the Corporation designated on
Schedule A below (or in a subsequent written modification to that Schedule)
is authorised to submit Contributions on behalf of the Corporation.
...
It is Your responsibility to notify the Project when any change is required
...
When you open your first PR, the CLA bot will comment with the exact
text to paste.  Today that line is:

> I have read the CLA Document and I hereby sign the CLA

Signing happens entirely in the PR — no PDFs, no DocuSign, no separate
account.  Your signature is recorded with your GitHub username + the
